...
module VecDotProduct_VecReader1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln4_1_reg_181;
reg    fifoA21_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln4_1_reg_181_pp0_iter1_reg;
reg    ddr_blk_n;
reg   [30:0] i_reg_104;
reg    ap_block_state1;
wire   [0:0] icmp_ln4_fu_115_p2;
reg   [59:0] trunc_ln4_1_reg_165;
wire   [30:0] trunc_ln4_fu_131_p1;
wire   [0:0] icmp_ln4_1_fu_144_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        i_reg_104 <= 31'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln4_1_fu_144_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_104 <= add_ln4_fu_149_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln4_1_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ddr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln4_fu_115_p2 == 1'd1))) begin
        trunc_ln4_1_reg_165 <= {{ddr_dout[63:4]}};
    end
end

always @ (*) begin
    if ((icmp_ln4_1_fu_144_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln4_1_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if ((~((ddr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ddr_read = 1'b1;
    end else begin
        ddr_read = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        fifoA21_write = 1'b1;
    end else begin
        fifoA21_write = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln4_1_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ddr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln4_fu_115_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else if ((~((ddr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1) & (icmp_ln4_fu_115_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln4_1_fu_144_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln4_1_fu_144_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((fifoA21_full_n == 1'b0) & (icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_ddr0_RVALID == 1'b0) & (icmp_ln4_1_reg_181 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((fifoA21_full_n == 1'b0) & (icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_ddr0_RVALID == 1'b0) & (icmp_ln4_1_reg_181 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((fifoA21_full_n == 1'b0) & (icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_ddr0_RVALID == 1'b0) & (icmp_ln4_1_reg_181 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_state1 = ((ddr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((m_axi_ddr0_RVALID == 1'b0) & (icmp_ln4_1_reg_181 == 1'd0));
end

always @ (*) begin
    ap_block_state11_pp0_stage0_iter2 = ((fifoA21_full_n == 1'b0) & (icmp_ln4_1_reg_181_pp0_iter1_reg == 1'd0));
end
...
assign icmp_ln4_1_fu_144_p2 = ((i_reg_104 == trunc_ln4_fu_131_p1) ? 1'b1 : 1'b0);
...
assign sext_ln4_fu_134_p1 = $signed(trunc_ln4_1_reg_165);

assign trunc_ln4_fu_131_p1 = readRep[30:0];

endmodule //VecDotProduct_VecReader1
