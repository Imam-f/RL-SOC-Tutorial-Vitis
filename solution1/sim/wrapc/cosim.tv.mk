...
$(ObjDir)/InterfaceModule.cpp_pre.cpp.tb.o : InterfaceModule.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling InterfaceModule.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ComputationModule.cpp_pre.cpp.tb.o : ComputationModule.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ComputationModule.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
