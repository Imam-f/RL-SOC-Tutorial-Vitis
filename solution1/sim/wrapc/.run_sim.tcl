...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/xilinx/vitis/2020.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/xilinx/vitis/2020.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/xilinx/vitis/2020.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/xilinx/vitis/2020.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "VecDotProduct.autotvin.dat"
	set constFileTvOut       "VecDotProduct.autotvout.dat"
	set constFileHdlTvIn     "VecDotProduct.autohdltvin.dat"
	set constFileHdlTvOut    "VecDotProduct.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
