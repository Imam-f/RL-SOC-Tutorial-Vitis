...
if {[file isfile VecDotProduct.autotvin.dat]} {
	file delete -force VecDotProduct.autotvin.dat
}

if {[file isfile VecDotProduct.autotvout.dat]} {
	file delete -force VecDotProduct.autotvout.dat
}
