...
//------------------------Parameter----------------------
`define TV_IN_ddr2 "../tv/cdatafile/c.VecDotProduct.autotvin_ddr2.dat"
`define TV_OUT_ddr2 "../tv/rtldatafile/rtl.VecDotProduct.autotvout_ddr2.dat"
 parameter ddr2_ADDR_BITWIDTH = 32'd 32;
 parameter ddr2_AWUSER_BITWIDTH = 32'd 1;
 parameter ddr2_DATA_BITWIDTH = 32'd 32;
 parameter ddr2_WUSER_BITWIDTH = 32'd 1;
 parameter ddr2_ID_BITWIDTH = 32'd 1;
 parameter ddr2_RUSER_BITWIDTH = 32'd 1;
 parameter ddr2_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter ddr2_C_DATA_BITWIDTH = 32'd 32;
parameter ddr2_mem_depth = 32'd 1;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_ddr2_AWVALID;
output  TRAN_ddr2_AWREADY;
input [ddr2_ADDR_BITWIDTH - 1 : 0] TRAN_ddr2_AWADDR;
input [ddr2_ID_BITWIDTH - 1 : 0] TRAN_ddr2_AWID;
input [8 - 1 : 0] TRAN_ddr2_AWLEN;
input [3 - 1 : 0] TRAN_ddr2_AWSIZE;
input [2 - 1 : 0] TRAN_ddr2_AWBURST;
input [2 - 1 : 0] TRAN_ddr2_AWLOCK;
input [4 - 1 : 0] TRAN_ddr2_AWCACHE;
input [3 - 1 : 0] TRAN_ddr2_AWPROT;
input [4 - 1 : 0] TRAN_ddr2_AWQOS;
input [4 - 1 : 0] TRAN_ddr2_AWREGION;
input [ddr2_AWUSER_BITWIDTH - 1 : 0] TRAN_ddr2_AWUSER;
input  TRAN_ddr2_WVALID;
output  TRAN_ddr2_WREADY;
input [ddr2_DATA_BITWIDTH - 1 : 0] TRAN_ddr2_WDATA;
input [ddr2_DATA_BITWIDTH/8 - 1 : 0] TRAN_ddr2_WSTRB;
input  TRAN_ddr2_WLAST;
input  TRAN_ddr2_WID;
input [ddr2_WUSER_BITWIDTH - 1 : 0] TRAN_ddr2_WUSER;
input  TRAN_ddr2_ARVALID;
output  TRAN_ddr2_ARREADY;
input [ddr2_ADDR_BITWIDTH - 1 : 0] TRAN_ddr2_ARADDR;
input [ddr2_ID_BITWIDTH - 1 : 0] TRAN_ddr2_ARID;
input [8 - 1 : 0] TRAN_ddr2_ARLEN;
input [3 - 1 : 0] TRAN_ddr2_ARSIZE;
input [2 - 1 : 0] TRAN_ddr2_ARBURST;
input [2 - 1 : 0] TRAN_ddr2_ARLOCK;
input [4 - 1 : 0] TRAN_ddr2_ARCACHE;
input [3 - 1 : 0] TRAN_ddr2_ARPROT;
input [4 - 1 : 0] TRAN_ddr2_ARQOS;
input [4 - 1 : 0] TRAN_ddr2_ARREGION;
input  TRAN_ddr2_ARUSER;
output  TRAN_ddr2_RVALID;
input  TRAN_ddr2_RREADY;
output [ddr2_DATA_BITWIDTH - 1 : 0] TRAN_ddr2_RDATA;
output  TRAN_ddr2_RLAST;
output [ddr2_ID_BITWIDTH - 1 : 0] TRAN_ddr2_RID;
output [ddr2_RUSER_BITWIDTH - 1 : 0] TRAN_ddr2_RUSER;
output [2 - 1 : 0] TRAN_ddr2_RRESP;
output  TRAN_ddr2_BVALID;
input  TRAN_ddr2_BREADY;
output [2 - 1 : 0] TRAN_ddr2_BRESP;
output [ddr2_ID_BITWIDTH - 1 : 0] TRAN_ddr2_BID;
output [ddr2_BUSER_BITWIDTH - 1 : 0] TRAN_ddr2_BUSER;
output [64 - 1 : 0] TRAN_ddr2_scaC;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [ddr2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [ddr2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [ddr2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [ddr2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [ddr2_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [ddr2_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [ddr2_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [64 - 1 : 0] scaC = 0;
reg [ddr2_DATA_BITWIDTH - 1 : 0] ddr2_mem_0 [0: ddr2_mem_depth - 1]; 
reg [ddr2_DATA_BITWIDTH - 1 : 0] ddr2_mem_1 [0: ddr2_mem_depth - 1]; 
reg [ddr2_DATA_BITWIDTH - 1 : 0] ddr2_mem_2 [0: ddr2_mem_depth - 1]; 
reg [ddr2_DATA_BITWIDTH - 1 : 0] ddr2_mem_3 [0: ddr2_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [ddr2_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [ddr2_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [ddr2_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_ddr2_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_ddr2_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_ddr2_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_ddr2_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_ddr2_BRESP = BRESP_tmp;
assign TRAN_ddr2_RDATA = RDATA_tmp;
assign TRAN_ddr2_RRESP = RRESP_tmp;
assign TRAN_ddr2_RLAST = RLAST_tmp;
assign TRAN_ddr2_RVALID = RVALID_tmp;
assign    TRAN_ddr2_scaC = scaC;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = ddr2_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  scaC <= 0 * DATA_byte_num;
end

initial begin : initialize_ddr2_mem
  integer i;
  for (i = 0; i < ddr2_mem_depth; i = i + 1) begin
      ddr2_mem_0[i] = 0;
      ddr2_mem_1[i] = 0;
      ddr2_mem_2[i] = 0;
      ddr2_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ddr2_AWREADY & TRAN_ddr2_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_ddr2_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_ddr2_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_ddr2_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_ddr2_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ddr2_ARREADY & TRAN_ddr2_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_ddr2_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_ddr2_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_ddr2_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_ddr2_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_ddr2_WREADY & TRAN_ddr2_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_ddr2_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_ddr2_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_ddr2_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ddr2_AWVALID && TRAN_ddr2_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ddr2_ARVALID && TRAN_ddr2_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ddr2_WVALID && TRAN_ddr2_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_ddr2_WVALID && TRAN_ddr2_WREADY && TRAN_ddr2_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_ddr2_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_ddr2_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [ddr2_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [ddr2_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [ddr2_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > ddr2_mem_depth) begin
                $display ("C:/Users/dell/Documents/Dev/MBKM/MBKM-Tutorial5/solution1/sim/verilog/AESL_axi_master_ddr2.v: Write request address %d exceed AXI master ddr2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, ddr2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = ddr2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = ddr2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = ddr2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = ddr2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : ddr2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : ddr2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : ddr2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : ddr2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = ddr2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = ddr2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = ddr2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = ddr2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : ddr2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : ddr2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : ddr2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : ddr2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > ddr2_mem_depth) begin
                $display ("C:/Users/dell/Documents/Dev/MBKM/MBKM-Tutorial5/solution1/sim/verilog/AESL_axi_master_ddr2.v: Read request address %d exceed AXI master ddr2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, ddr2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= ddr2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= ddr2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= ddr2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= ddr2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_ddr2_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= ddr2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= ddr2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= ddr2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= ddr2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer ddr2_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [ddr2_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [ddr2_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  ddr2_bitwidth = ddr2_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (ddr2_bitwidth , factor);
  fp = $fopen(`TV_IN_ddr2,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_ddr2); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [ddr2_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 1 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : ddr2_mem_0[i/factor] = mem_tmp;
                      1 : ddr2_mem_1[i/factor] = mem_tmp;
                      2 : ddr2_mem_2[i/factor] = mem_tmp;
                      3 : ddr2_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : ddr2_mem_0[i] = mem_tmp;
                  1 : ddr2_mem_1[i] = mem_tmp;
                  2 : ddr2_mem_2[i] = mem_tmp;
                  3 : ddr2_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [ddr2_DATA_BITWIDTH - 1: 0] = 0;
          end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer ddr2_bitwidth; 
  reg [ddr2_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [ddr2_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  ddr2_bitwidth = ddr2_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (ddr2_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_ddr2, "a"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_ddr2); 
          $finish; 
      end 
      $fdisplay(fp, "[[transaction]] %d", transaction_num);
      for(i = 0; i < (ddr2_mem_depth - ddr2_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = ddr2_mem_0[i/factor];
                  1 : tmp_data = ddr2_mem_1[i/factor];
                  2 : tmp_data = ddr2_mem_2[i/factor];
                  3 : tmp_data = ddr2_mem_3[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = ddr2_mem_0[i];
                  1 : mem_tmp = ddr2_mem_1[i];
                  2 : mem_tmp = ddr2_mem_2[i];
                  3 : mem_tmp = ddr2_mem_3[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = ddr2_mem_0[ddr2_mem_depth/factor];
              1 : tmp_data = ddr2_mem_1[ddr2_mem_depth/factor];
              2 : tmp_data = ddr2_mem_2[ddr2_mem_depth/factor];
              3 : tmp_data = ddr2_mem_3[ddr2_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((ddr2_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((ddr2_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((ddr2_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((ddr2_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",ddr2_mem_0[ddr2_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",ddr2_mem_1[ddr2_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",ddr2_mem_2[ddr2_mem_depth/factor][15:0]);
                  3 : $fdisplay(fp,"0x%x",ddr2_mem_3[ddr2_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end
