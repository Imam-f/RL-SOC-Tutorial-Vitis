...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.VecDotProduct.autotvin_ddr0.dat"
         "c.VecDotProduct.autotvin_ddr1.dat"
         "c.VecDotProduct.autotvin_vecA.dat"
         "c.VecDotProduct.autotvin_vecB.dat"
         "c.VecDotProduct.autotvin_scaC.dat"
         "c.VecDotProduct.autotvin_readRep.dat"
         "c.VecDotProduct.autotvout_ddr2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.VecDotProduct.autotvout_ddr2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
