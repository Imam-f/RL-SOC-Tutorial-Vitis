...
`define AUTOTB_TVIN_ddr0  "./c.VecDotProduct.autotvin_ddr0.dat"
`define AUTOTB_TVIN_ddr1  "./c.VecDotProduct.autotvin_ddr1.dat"
`define AUTOTB_TVIN_vecA  "./c.VecDotProduct.autotvin_vecA.dat"
`define AUTOTB_TVIN_vecB  "./c.VecDotProduct.autotvin_vecB.dat"
`define AUTOTB_TVIN_scaC  "./c.VecDotProduct.autotvin_scaC.dat"
`define AUTOTB_TVIN_readRep  "./c.VecDotProduct.autotvin_readRep.dat"
`define AUTOTB_TVIN_ddr0_out_wrapc  "./rtl.VecDotProduct.autotvin_ddr0.dat"
`define AUTOTB_TVIN_ddr1_out_wrapc  "./rtl.VecDotProduct.autotvin_ddr1.dat"
`define AUTOTB_TVIN_vecA_out_wrapc  "./rtl.VecDotProduct.autotvin_vecA.dat"
`define AUTOTB_TVIN_vecB_out_wrapc  "./rtl.VecDotProduct.autotvin_vecB.dat"
`define AUTOTB_TVIN_scaC_out_wrapc  "./rtl.VecDotProduct.autotvin_scaC.dat"
`define AUTOTB_TVIN_readRep_out_wrapc  "./rtl.VecDotProduct.autotvin_readRep.dat"
`define AUTOTB_TVOUT_ddr2  "./c.VecDotProduct.autotvout_ddr2.dat"
`define AUTOTB_TVOUT_ddr2_out_wrapc  "./impl_rtl.VecDotProduct.autotvout_ddr2.dat"
module `AUTOTB_TOP;
